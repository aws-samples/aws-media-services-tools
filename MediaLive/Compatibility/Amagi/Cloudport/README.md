# RTMP Streaming with the Amagi Cloudport Player and AWS MediaLive
...
4. [Configure the Cloudport Player](#4-configure-the-cloudport-player)
...
### 4. Configure the Cloudport Player
The MediaLive input creation provides two input URLs with the following structure:
```
rtmp://[ip address 1]:1935/input1/[channel id]
rtmp://[ip address 2]:1935/input2/[channel id]
```
Configure the Amagi Cloudport Player using the provided RTMP inputs.
