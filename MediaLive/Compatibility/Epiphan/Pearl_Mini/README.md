...
4. [Configure Elemental Live to push RTMP to MediaLive](#4-configure-the-pearl-mini-to-push-to-the-medialive-input)
<br>
...
### 4. Configure the Pearl Mini to push to the MediaLive Input
