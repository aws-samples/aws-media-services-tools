# RTMP Streaming with the Grass Valley GV I/O and AWS MediaLive
...
4. [Configure the GV I/O](#4-configure-the-gv-i/o)
...
### 4. Configure the GV I/O
- [Grass Valley GV I/O documentation](https://www.grassvalley.com/products/gv_io/)
...
```
Configure the GV I/O using the provided RTMP inputs.
