...
4. [Configure Monarch HD to push to the MediaLive Input](#4-configure-monarch-hd-to-push-to-the-medialive-input)
<br>
...
Parameter | Notes
------------ | -------------
rtmpDestinationURL | rtmp://[ip address]/hd
rtmpStreamName | [channel id]-1
rtmpDestinationURL | rtmp://[ip address]/hd2
