# RTP Streaming with the Nevion Virtuoso and AWS MediaLive
...
4. [Configure the Nevion Virtuoso](#4-configure-the-nimbra-va)
...
### 4. Configure the Nevion Virtuoso
- [Nevion Virtuoso Documentation](https://nevion.com/products/nevion-virtuoso/)
The MediaLive input creation will provide two input URLs with the following structure:
```
rtp://[ip address 1]:5000/
rtp://[ip address 2]:5000/
```

Configure the Nevion Virtuoso for multicast using the provided RTP inputs.
